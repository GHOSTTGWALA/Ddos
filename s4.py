...
bot = telebot.TeleBot('6959421219:AAHR-KbA8GYhwes2uRh7DB1yyHW5_zPGP0g')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴀᴘᴘʀᴏᴠᴇ ʙʏ ᴀᴅᴍɪɴ ᴘʟᴇᴀꜱᴇ ᴄᴏɴᴛᴀᴄᴛ --> @AaTank_GHOST"
